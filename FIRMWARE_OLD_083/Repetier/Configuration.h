...
#define EXT0_STEPS_PER_MM 92.4 //steves extruder    set to 92 for ezstruder
...
#define EXT0_EXTRUDER_COOLER_PIN -1  // turned off pin 7 to eliminate PWM issues with atmega chip
...
#define HAVE_HEATED_BED true   //for now, no heated bed
...
/** After x seconds of inactivity, the stepper motors are disabled.
    ...
    Overridden if EEPROM activated.
*/
#define STEPPER_INACTIVE_TIME 60000
/** After x seconds of inactivity, the system will go down as far it can.
    ...
    Overridden if EEPROM activated. 
*/
#define MAX_INACTIVE_TIME 90000
...
#define UI_VERSION_STRING2 "SeeMeCNC ORION"
